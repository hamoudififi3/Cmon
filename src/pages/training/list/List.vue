<template>
  <v-data-table :headers="headers" :items="trains" :sort-by="[{ key: 'email', order: 'asc' }]">
    <template v-slot:top>
      <v-toolbar flat>
        ...
        <v-spacer></v-spacer>
        <Comp @saveTrain="AddTrain" :teachers="teachers" />
      </v-toolbar>
    </template>
  ...
  <Edit :train="editedItem" :teachers="teachers"  @save-changes="EditTrains" ref="editItemDialog" />
...
export default {
  ...
  data() {
    return {
      trains: [],
      teachers: [
        { Name: "Mr Saci" , Email: "hamoudififi123@gmail.com", },
        { Name: "Mr Ramdani",  Email: "bibosss@gmail.com" },
        { Name: "Mrs Malak", Email: "gigobibi@gmail.com" }
      ],
      dialog: false,
      dialogDelete: false,
      editedItem: {},
      ...
      headers: [
        ...
        { title: "Number of Students", value: "numberOfStudents" },
      ...
      this.trains = [
        {
          ...
          teacher: "Mr Saci",
          numberOfStudents: 0,
          Email: "hamoudififi123@gmail.com",
          Age: "49"
        },
        {
            Name: "Cristiano",
